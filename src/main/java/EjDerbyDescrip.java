...
public class EjDerbyDescrip {
    public static void main(String[] args) {
        try {
            ...
            String urlConexion = "jdbc:derby:C:/Users/MateBook/Desktop/DAM/2§DAM/ACDAT/TEMA 2/baseDerby/prac_embebidas";
            ...
            rs = dbmd.getTables(null, "practica", null, null);
            while (rs.next()){
